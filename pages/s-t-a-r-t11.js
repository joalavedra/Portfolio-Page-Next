  ...
  return (
    <>
      <div className="container">
        <Head>
          <title>START11 - Portfolio Page</title>
          <meta property="og:title" content="START11 - Portfolio Page" />
        </Head>
        ...
        <div className="container1">
          <div className="hero">
            ...
            <div className="cta-btn-container">
              ...
              <button className="cta-btn1 button anchor">HOW IT WORKS</button>
            </div>
          </div>
        </div>
        <div className="hero1">
          ...
          <div className="container2">
            <div className="btn-group">
              <Link href="/s-t-a-r-t111">
                <a className="link6 card-Text button">Mint 0.02 ETH</a>
              </Link>
            </div>
            <h2 className="text1">Current Pool 0.54 ETH</h2>
